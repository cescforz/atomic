...
public class BaseAutoGenModel<T extends Model<T>> extends Model<T> {
    ...
    @DateTimeFormat(pattern = SystemConstants.DATE_PATTERN_24) // 入参格式化
    @JsonFormat(pattern = SystemConstants.DATE_PATTERN_24,timezone = SystemConstants.DEFAULT_TIME_ZONE) //出参格式化
